    ...
    <div className="font-body-md text-body-md overflow-x-hidden">
      <main>
        ...
        <section className="relative bg-on-primary-fixed overflow-hidden min-h-[716px] flex items-center">
          <div className="absolute inset-0 opacity-20 blueprint-pattern pointer-events-none transition-all duration-700 opacity-100 translate-y-0" />
          <div className="absolute inset-0 bg-gradient-to-r from-on-primary-fixed via-on-primary-fixed/80 to-transparent z-10 transition-all duration-700 opacity-100 translate-y-0" />
          <div className="relative z-20 max-w-container-max mx-auto px-gutter grid grid-cols-1 lg:grid-cols-2 gap-2xl items-center py-2xl transition-all duration-700 opacity-100 translate-y-0">
            <div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-surface-container-highest rounded-xl overflow-hidden shadow-2xl aspect-[4/3] border border-outline-variant/30">
                <img
                  ...
                  src="https://gypspace.s3.us-east-1.amazonaws.com/mep_hvac_hero.jpg"
        ...
        <section className="py-2xl bg-surface">
          <div className="max-w-container-max mx-auto px-gutter">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-lg">
              ...
              <div className="md:col-span-8 bg-white border border-outline-variant p-xl rounded-xl flex flex-col md:flex-row gap-xl hover:border-technical-cyan transition-colors group">
                ...
                <div className="flex-1 rounded-lg overflow-hidden bg-surface-container h-64 md:h-auto border border-outline-variant">
                  <img
                    ...
                    src="https://gypspace.s3.us-east-1.amazonaws.com/mep_hvac_diagram.jpg"
              ...
              {/* Home Automation */}
              <div className="md:col-span-8 bg-white border border-outline-variant p-xl rounded-xl flex flex-col md:flex-row gap-xl hover:border-technical-cyan transition-colors group">
                <div className="flex-1 order-2 md:order-1 rounded-lg overflow-hidden bg-surface-container h-64 md:h-auto border border-outline-variant">
                  <img
                    className="w-full h-full object-cover"
                    src="https://gypspace.s3.us-east-1.amazonaws.com/mep_home_automation.jpg"
                    alt="Smart home automation control panel"
                  />
                </div>
                <div className="flex-1 order-1 md:order-2">
                  <span className="material-symbols-outlined text-technical-cyan text-4xl mb-md">smart_home</span>
                  <h3 className="font-headline-sm text-headline-sm mb-md">Home Automation</h3>
                  <p className="font-body-md text-body-md text-secondary mb-md">Integrated smart solutions for residential and commercial environments, featuring centralized control, lighting automation, and climate management.</p>
                  <ul className="space-y-2 font-body-sm text-body-sm text-on-surface-variant">
                    <li className="flex items-center gap-2"><span className="material-symbols-outlined text-xs">check_circle</span> Centralized Control Systems</li>
                    <li className="flex items-center gap-2"><span className="material-symbols-outlined text-xs">check_circle</span> Intelligent Lighting &amp; Shading</li>
                    <li className="flex items-center gap-2"><span className="material-symbols-outlined text-xs">check_circle</span> Smart Energy Management</li>
                  </ul>
                  <div className="mt-auto pt-md border-t border-outline-variant">
                    <span className="font-mono-utility text-mono-utility text-technical-cyan">02 / SMART ECOSYSTEMS</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2xl items-center">
              <div className="relative aspect-video rounded-xl overflow-hidden group">
                <img
                  ...
                  src="https://gypspace.s3.us-east-1.amazonaws.com/mep_case_study_new.jpg"
        ...
        <section className="py-2xl bg-technical-cyan relative overflow-hidden">
          <div className="absolute inset-0 blueprint-pattern opacity-10 pointer-events-none transition-all duration-700 opacity-100 translate-y-0" />
